...
<Info>
  To test webhooks locally, we've configured the Stripe CLI to forward webhooks
  to your local server. This will start automatically when you run `pnpm dev`.
</Info>
...
<Tip>
  Make sure you enable the webhook events you need in your Clerk project
  settings.
</Tip>
